...
export default function PropertiesDetails({ property }: any) {
  ...
  // Fetch seller details from supabase user table
  ...
  //     console.log("sellerDetails:", sellerDetails, Number(sellerId) );
            ...
            <div className="col-lg-6">
              <div className="img1 #">
                <img
                  src={
                    images[0]?.url ||
                    "/assets/img/all-images/properties/property-img37.png"
                  }
                  alt="housa"
                ...
                {/* <div className="col-lg-6 col-md-6">
                  ...
                  <div className="img1 #">
                    <img
                      src={
                        images[1]?.url ||
                        "/assets/img/all-images/properties/property-img38.png"
                      }
                      alt="housa"
                      style={{
                        height: "250px",
                ...
                <div className="col-lg-6 col-md-6">
                  ...
                  <div className="img1 #">
                    <img
                      src={
                        images[2]?.url ||
                        "/assets/img/all-images/properties/property-img39.png"
                      }
                      alt="housa"
                      style={{
                        height: "250px",
                  ...
                  <div className="col-lg-6 col-md-6">
                    ...
                    <div className="img1 #">
                      <img
                        src={
                          images[0]?.url ||
                          "/assets/img/all-images/properties/property-img40.png"
                        }
                        alt="housa"
                        style={{
                          height: "250px",
                ...
                {/* <div className="col-lg-6 col-md-6">
                  ...
                  <div className="img1 #">
                    <img
                      src={
                        images[4]?.url ||
                        "/assets/img/all-images/properties/property-img41.png"
                      }
                      alt="housa"
                      style={{
                        height: "250px",
