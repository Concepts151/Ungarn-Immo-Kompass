                    ...
                    <div className="property-widget-sidebar">
                      <div className="img1">
                        <video
                          ...
                          className=""
                          style={{ width: "100%", height: "500px", borderRadius: 10, backgroundColor: "#000" }}
                        >
                      ...
                      <div className="padding-side">
                        ...
                        <p>
                          ...
                          Woodland, offering the perfect blend of modern comfort
                          and timeless elegance. Designed for both functionality
                          and style, this property features spacious rooms,
                          high-quality finishes, and an inviting atmosphere that
                          feels like home. Whether you're looking for a peaceful
                          retreat or a prime investment opportunity, this
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6">
                            <div className="others-box">
                              ...
                              <div className="text">
                                <p>
                                  <span>Healthcare: </span> Nearby Hospitals and
                                  Clinic.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="col-lg-6">
                            <div className="others-box">
                              ...
                              <div className="text">
                                <p>
                                  <span> Transport:</span> Metro, Bus Station,
                                  Highway &amp; Nearby International Airport.
                                </p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="others-box">
                              ...
                              <div className="text">
                                <p>
                                  ...
                                  Malls, Markets, Entertainment Centers.
                                </p>
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-6">
                            <div className="others-box">
                              ...
                              <div className="text">
                                <p>
                                  <span>Park &amp; Recreation: </span> Parks
                                  Sport Center, Fitness Club, Swimming Center.
                                </p>
                              </div>
                            </div>
                          </div>
