          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              <div className="footer-time-area">
                ...
                <p>
                  Your trusted partner for buying an, selling, and renting
