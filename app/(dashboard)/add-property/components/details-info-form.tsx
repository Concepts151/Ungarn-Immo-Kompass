...
const DetailsForm = ({
  ...
  const handleMonthlyCostChange = (costType: keyof MonthlyCosts, value: string) => {
  ...
  const handleBooleanChange = (field: 'hasRollerShutters' | 'energyCertificate', value: string) => {
  ...
  const validateForm = () => {
    ...
    if (!data.heatingType.trim()) newErrors.heatingType = "Heating type is required";
    if (!data.heatingCondition.trim()) newErrors.heatingCondition = "Heating condition is required";
    if (!data.electricCondition.trim()) newErrors.electricCondition = "Electric condition is required";
    if (!data.waterCondition.trim()) newErrors.waterCondition = "Water condition is required";
    if (!data.internetType.trim()) newErrors.internetType = "Internet type is required";
    if (!data.internetSpeed.trim()) newErrors.internetSpeed = "Internet speed is required";
