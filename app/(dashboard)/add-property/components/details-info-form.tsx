      ...
      <div className="upload-main-boxarea">
        ...
        <div className="row">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="space28" />
            <div className="input-area">
              <h5>{t("details_windows")} Age (years)</h5>
              <div className="space16" />
              <input
                type="number"
                placeholder="0"
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <div className="input-area">
              ...
              <select
                ...
                onChange={(e) =>
                  handleBooleanChange("hasRollerShutters", e.target.value)
                }
              >
          ...
          <div className="col-lg-4 col-md-6">
            <div className="space28" />
            <div className="input-area">
              <h5>{t("details_heating")} Condition*</h5>
              <div className="space16" />
              <select
              ...
              >
                ...
                <option value="Felújítandó">
                  Felújítandó (Needs renovation)
                </option>
              </select>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="space28" />
            <div className="input-area">
              <h5>{t("details_electric_condition")}*</h5>
              <div className="space16" />
              <select
          ...
          <div className="col-lg-4 col-md-6">
            <div className="space28" />
            <div className="input-area">
              <h5>{t("details_water_condition")}*</h5>
              <div className="space16" />
              <select
          ...
          <div className="col-lg-4 col-md-6">
            <div className="space28" />
            <div className="input-area">
              <h5>{t("details_energy_certificate")}</h5>
              <div className="space16" />
              <select
                className="form-select"
                ...
                onChange={(e) =>
                  handleBooleanChange("energyCertificate", e.target.value)
                }
              >
                <option value="false">No</option>
                <option value="true">Yes</option>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="space28" />
            <div className="input-area">
              <h5>{t("details_energy_consumption")} (kWh/m²/year)</h5>
              <div className="space16" />
              <input
                type="number"
                placeholder="0"
          ...
          <div className="col-lg-4 col-md-6">
            <div className="space28" />
            <div className="input-area">
              <h5>{t("details_internet")} Speed (Mbps)*</h5>
              <div className="space16" />
              <input
                type="number"
        ...
        <div className="row">
          <div className="col-12">
            <div className="space28" />
            <h5>{t("details_monthly_costs")} (HUF)</h5>
            <div className="space16" />
          </div>

          <div className="col-lg-2 col-md-4 col-6">
            <div className="input-area">
              <label>{t("details_electricity")}</label>
              <input
                type="number"
                placeholder="0"
                min="0"
                ...
                onChange={(e) =>
                  handleMonthlyCostChange("electricity", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="col-lg-2 col-md-4 col-6">
            <div className="input-area">
              ...
              <input
                ...
                onChange={(e) =>
                  handleMonthlyCostChange("water", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="col-lg-2 col-md-4 col-6">
            <div className="input-area">
              ...
              <input
                ...
                onChange={(e) =>
                  handleMonthlyCostChange("trash", e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="col-lg-2 col-md-4 col-6">
            <div className="input-area">
              <label>{t("details_total")}/Month</label>
              <input
                type="number"
                value={
