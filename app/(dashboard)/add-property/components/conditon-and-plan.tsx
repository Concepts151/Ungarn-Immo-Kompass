      ...
      <div className="upload-main-boxarea">
        ...
        <div className="row">
          ...
          <div className="col-lg-12 col-md-12">
            <div className="space28" />
            <div className="input-area">
              <h5>Damage Discription</h5>
              <div className="space16" />
              <textarea
                placeholder="Describe any damage to the property"
          ...
          <div className="col-lg-12 col-md-12">
            ...
            <div className="input-area">
              ...
              <div className="space16" />
              <textarea
                placeholder="Dexcribe any renovation needed"
        ...
        <div className="row">
          ...
          <div className="property-main-boxarea">
            <div className="space48" />
            <h4>Upload floor plans Of Your Property</h4>
