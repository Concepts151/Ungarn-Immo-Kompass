...
import PropertyFilter from "@/components/elements/custom-elements/property-filter";
...
export default function SidebarGrid() {
  ...
  const { properties, favoriteProperties } = useSelector(
  ...
  const {
    ...
    filters,
    totalCount,
  } = useSelector((state: RootState) => state.listingFilter);
  ...
  const {
    ...
    actions: { setCurrentPage, setItemsPerPage, setSortOrder, setViewMode },
    paginatedProperties,
    totalPages,
  ...
  const handleSortOrderChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    if (e.target.value == "oldest")
      dispatch(fetchListings({ sortBy: "created_at", sortOrder: "desc" }));
    if (e.target.value == "newest")
      dispatch(fetchListings({ sortBy: "created_at", sortOrder: "asc" }));
    if (e.target.value == "price-low")
      dispatch(fetchListings({ sortBy: "price", sortOrder: "asc" }));
          ...
          <div className="love-share">
            ...
            >
              <img
                ...
                alt="favorite"
                className={
                  favoriteProperties.includes(property.id) ? "heart2" : "heart1"
                }
              />
            </Link>
  ...
  //   listing rendering
  const renderListingImages = (listing: ListingItem) => {
    if (typeof window === "undefined") return null; // Early return on server-side

    if (listing.images && Object.keys(listing.images).length > 0) {
      return (
        <DynamicSwiper {...swiperFade} className="swiper swiper-fade">
          <div className="swiper-wrapper">
            {Object.values(listing.images).map((image, index) => (
              <DynamicSwiperSlide key={index}>
                <img
                  src={
                    image ||
  ...
  const renderListingGridItems = (listing: ListingItem) => (
    <div className="property-single-boxarea">
      <div className="property-list-img-area">
        <div className="img1">{renderListingImages(listing)}</div>
      </div>
      <div className="space20"></div>
      <div className="rent-sale-area">
        {/* <ul>
      ...
      <div className="property-price">
        <div className="text">
          <Link href={`/property-details/${listing.id}`}>{listing.title}</Link>
          <div className="space16" />
          <p>
            {listing.basicDetails?.address!}, {listing.basicDetails?.city},{" "}
            {listing.basicDetails?.country}
          </p>
        </div>
        <Link href="#" className="price">
          ${listing.basicDetails?.price.toLocaleString()}
          {/* {property.status === "For Rent"} */}
        </Link>
      </div>
      <div className="space20" />
        ...
        <ul>
          <li>
            <div>
              ...
              {listing.basicDetails?.living_area}sqft
            </div>
          </li>
          <li>
            <div>
              ...
              {listing.basicDetails?.bedroom}Beds
            </div>
          </li>
          <li>
            <div>
              ...
              {listing.basicDetails?.bathroom} Baths
            </div>
          </li>
        </ul>
        <div className="space24" />
  ...
  const renderListingListItems = (listing: ListingItem) => (
    <div className="property-single-boxarea">
      <div className="row align-items-center">
        <div className="col-lg-6 col-md-6 position-relative">
          <div className="property-list-img-area">
        ...
        <div className="col-lg-6 col-md-6">
          <div className="property-price">
            <div className="text">
              ...
              <div className="space16" />
              <p>
                {listing.basicDetails?.address! || "n/a"},{" "}
                {listing.basicDetails?.city! || "n/a"},{" "}
                {listing.basicDetails?.country! || "n/a"}
              </p>
            </div>
            <Link href="#" className="price">
              ${listing.basicDetails?.price.toLocaleString()}
  ...
  //   function addCommasSimple(number: number) {
                        ...
                        <div className="tab-content">
                          ...
                          >
                            <div className="row g-4">
                              {listings.map((property) => (
                                ...
                                >
                                  {renderListingGridItems(property)}
                                </div>
                              ))}
                            </div>
                          </div>
                          ...
                          >
                            ...
                            <div className="row g-4">
                              {listings.map((property) => (
                                <div key={property.id} className="col-12">
                                  {renderListingListItems(property)}
                                </div>
                              ))}
                            </div>
                          </div>
