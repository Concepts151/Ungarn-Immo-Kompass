...
const UpdateOverview: React.FC<UpdateOverviewProps> = ({
  descriptionData,
  mediaData,
  videoData = [],
  locationData,
  ...
  return (
    <div className="upload-main-boxarea">
      ...
      <p className="text-muted">
        Please review all the information before updating your property listing.
      </p>
      ...
      <div className="overview-section">
        ...
        <div className="overview-grid">
          ...
          <div className="overview-item">
            ...
            <span className="overview-value">{descriptionData.category || "—"}</span>
          </div>
          <div className="overview-item">
